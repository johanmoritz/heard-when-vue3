<template>
  <div>
    <button class="btn" @click="modalOpen = true">
      Help
    </button>

    <div class="help" v-show="modalOpen">
      <button class="btn btn-exit" @click="modalOpen = false">
        X
      </button>
      <h2>Help</h2>
      ...
      <h3>About</h3>
      <p>
        Heard When is a music trivia game inspired by the Swedish board game
        "När då då?". <br />
